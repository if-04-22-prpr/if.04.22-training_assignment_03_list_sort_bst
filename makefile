...
LIBRARY_FILES    = shortcut allocator sensor_data
ASSIGNMENT_HDRS  = list.h list_iterator.h list_types.h
ASSIGNMENT_FILES = linked_list sort sorting_criteria bst comparators visitors
TEST_FILES       = test_list test_sort test_functions test_bst
